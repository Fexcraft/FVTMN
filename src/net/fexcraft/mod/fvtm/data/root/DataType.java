...
public enum DataType {
	...
	public final Class<? extends Registrable<?>> core;
	
	DataType(String suffix, String cfg_folder, Class<? extends Registrable<?>> type){
		this.suffix = suffix; this.cfg_folder = cfg_folder; this.core = type;
	}

	public <T extends Registrable<T>> Registry<T> getRegistry(){
		switch(this){
	...
	public void register(Registrable<?> core){
		switch(this){
