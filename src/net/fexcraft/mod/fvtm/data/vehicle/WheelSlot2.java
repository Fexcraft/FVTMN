...
public class WheelSlot2 {
	...
	public boolean powered(Object data){
		return powered == null ? false : powered.length() == 0;//TODO || data check attr bool
	}
